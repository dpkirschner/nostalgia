...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_tenancies_location_id_is_current",
        "tenancies",
        ["location_id", "is_current"],
        unique=False,
    )
    op.create_index(
        "idx_tenancies_location_business",
        "tenancies",
        ["location_id", "business_name"],
        unique=True,
    )
    ...
    op.create_index(
        "idx_memory_submissions_location_id", "memory_submissions", ["location_id"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index("idx_tenancies_location_business", table_name="tenancies")
